...
- 한 줄은 최대 99자를 넘지 않아야 합니다.
    ...
    ⚠️ *기존에는 119자를 사용하였으나, Swift 3.0 에서 문법이 간략화되면서 더 적은 수로도 가능하게 되었습니다. 99자로 우선 적용해보고, 너무 부족하다는 판단이 생길 경우 다시 119자로 변경할 계획입니다.*

    Xcode의 **Preferences → Text Editing → Editing**의 'Page guide at column' 옵션을 활성화하고 79자로 설정하면 편리합니다.
